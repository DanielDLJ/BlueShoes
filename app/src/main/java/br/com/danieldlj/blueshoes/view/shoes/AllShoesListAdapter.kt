...
import br.com.danieldlj.blueshoes.domain.Rate
import br.com.danieldlj.blueshoes.domain.Shoes
import com.squareup.picasso.Picasso
import android.view.ViewGroup as ViewGroup1

class AllShoesListAdapter(private val shoesList: List<Shoes>) :
    RecyclerView.Adapter<AllShoesListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup1, type: Int ): ViewHolder {
